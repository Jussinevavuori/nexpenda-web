import "./DeprecatedFileUploader.scss";
...
import { useDeprecatedFileUploaderController } from "./useDeprecatedFileUploaderController";

export type DeprecatedFileUploaderProps = {
}

export function DeprecatedFileUploader(props: DeprecatedFileUploaderProps) {

	const controller = useDeprecatedFileUploaderController(props)
	...
	return <div className="DeprecatedFileUploader">
